...
ticketPriceTotal.push(
  donations.reduce((accumulator, currentValue) => {
...
// Problem 1
//the director needs an email list for all the runners
let eMails = [];
runners.forEach(element => {
...
// Problem 2
//but he dosen't like people who use gmail, he's going to uninvite them
let Gmail = [];

Gmail.push(runners.filter(element => element.email_provider == "gmail"));

console.log(Gmail);

// Problem 3
//runners who gave more than $200 get a callender
let bigMoney = [];
bigMoney.push(runners.filter(element => element.donation > 200));
